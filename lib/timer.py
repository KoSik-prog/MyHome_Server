...
class Timer:
    ...
    def auto_timer(self, deviceClass):
        ...
        try:
            zmiennaON = datetime.datetime.strptime(
                str(aktual), format) - datetime.datetime.strptime(deviceClass.autoOn, format)  # obliczenie roznicy czasu
        except ValueError as e:
            print('Blad czasu wł:', e)
        try:
            zmiennaOFF = datetime.datetime.strptime(
                str(aktual), format) - datetime.datetime.strptime(deviceClass.autoOff, format)  # obliczenie roznicy czasu
        except ValueError as e:
