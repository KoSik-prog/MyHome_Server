...
class Nrf():
    ...
    #             # ------------------------------------------------------------------------------------------------------------
    #             elif stringNRF[1:3] == "03":  #outside sensor
    #                 sensorOutside.add_record(stringNRF)
    #             # ------------------------------------------------------------------------------------------------------------
    #             elif stringNRF[1:3] == "04":  # czujnik temperatury 2 - pokoju
    #                 sensorRoom1Temperature.decode_data(stringNRF)
    #             # ------------------------------------------------------------------------------------------------------------
    #             elif stringNRF[1:3] == "05":  # LED - tv
    #                 if stringNRF[3] == "?":
    ...
    #             # ------------------------------------------------------------------------------------------------------------
    #             elif stringNRF[1:3] == "06":  # LED KUCHNIA
    #                 if stringNRF[3] == ".":
    ...
    #             # ------------------------------------------------------------------------------------------------------------
    #             elif stringNRF[1:3] == "09":  # DEKORACJE 2 POK 1
    #                 if stringNRF[3] == "?":
    ...
    #             # ------------------------------------------------------------------------------------------------------------
    #             # elif ledDeskRoom3.handle_nrf(stringNRF) == True:
    #             #     return True
    ...
    #             # ------------------------------------------------------------------------------------------------------------
    #             elif stringNRF[1:3] == "20":  # lego light
    #                 if stringNRF[3] == "?":
    #                     if stringNRF[4:7].isdigit():
    ...
    #             # ------------------------------------------------------------------------------------------------------------
    #             elif stringNRF[1:3] == "20":  # terrace light
    #                 if stringNRF[3] == "?":
    #                     if stringNRF[4] == "P":
