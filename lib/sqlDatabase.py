...
class Sql:
    ...
    def add_record_watering_can(self, humidity, sun, water,  power, humidity_raw, watering):
        self.add_record("kwiatek1", "{}, {}, {}, {}, {}, {}".format(humidity, sun, water, power, humidity_raw, watering))
    ...
    def add_record_terrarium(self, tempUP, humiUP, tempDN, humiDN, uvi):
        self.add_record("terrarium".format(flowerNumber), "{}, {}, {}, {}, {}".format(tempUP, humiUP, tempDN, humiDN, uvi))
