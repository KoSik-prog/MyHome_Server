...
class Sensors:
    ...
    def check_sensor(self):
        ...
        self.set_receive_error_on_strip(sensorFlower1, 63, 4)
        self.set_receive_error_on_strip(sensorFlower2, 63, 5)
        self.set_receive_error_on_strip(sensorFlower3, 63, 6)
        # self.set_receive_error_on_strip(sensorFlower5, 63, 16)
        # self.set_receive_error_on_strip(sensorFlower6, 63, 19)
        # power check
        self.set_power_error_on_strip(sensorFlower1, Sensors.minBatteryVoltage, 8)
        self.set_power_error_on_strip(sensorFlower2, Sensors.minBatteryVoltage, 9)
        self.set_power_error_on_strip(sensorFlower3, Sensors.minBatteryVoltage, 10)
        ...
        self.set_min_humidity_error_on_strip(sensorFlower1, 11)
        self.set_min_humidity_error_on_strip(sensorFlower2, 12)
